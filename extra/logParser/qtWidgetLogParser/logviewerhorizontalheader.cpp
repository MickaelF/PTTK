...
LogViewerHorizontalHeader::LogViewerHorizontalHeader(QWidget* parent)
    : QHeaderView(Qt::Horizontal, parent)
{
    ...
    connect(this, &QHeaderView::sectionClicked, this, &LogViewerHorizontalHeader::onSectionClicked);
}
...
void LogViewerHorizontalHeader::onSectionClicked(int section)
{
    ...
    if (!isSortIndicatorShown()) setSortIndicatorShown(true);
